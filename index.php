...
<main>
  <div class="shell">
    ...
    <section class="hero">
      ...
      <p class="disclaimer">It will not prove anything. Automated detection of AI-generated source performs near chance in peer-reviewed benchmarks, so this shows its working and expects you to read it. Do not accuse anyone of anything on the strength of a number.</p>
    </section>
